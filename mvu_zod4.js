...
const relationshipSchema = zod.record(zod.string(), zod.object({
    ...
    Outfit: zod.object({
        Overview: zod.string().prefault(''), Top: zod.string().prefault(''), Bottom: zod.string().prefault(''),
        Underwear: zod.string().prefault(''), ShoesSocks: zod.string().prefault(''), Jewelry: zod.string().prefault(''),
    }).prefault({}),
